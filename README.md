...
- MQTT API
  ...
  - [Управление VakioAtmosphere](#atmosphere)
    ...
    - [+/co2](#atmosphereco2)
    - [+/hud](#atmospherehud)
  - [Управление VakioCityAir (250, 500)](#cityair)
    - [+/+/lwt](#cityair_lwt)
...
- REST API
  ...
  - [Управление VakioCityair500](rest/cityair500.md)
...
### <a name="cityair"></a> Управление VakioCityair (250, 500)
...
#### <a name="cityair_lwt"></a> Топик +/+/lwt (только на 250)

```
При отключении прибора от серверу происходит публикация сообщения "Offline"
```

#### <a name="cityair_system"></a> Топик на подписку +/+/system (только на 250)
